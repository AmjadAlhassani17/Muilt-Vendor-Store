...
@section('title', 'CheckOut - ShopGrid')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][email_address]" placeholder="Email Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][mailing_address]" placeholder="Mailing Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.s-select name="addr[billing][country]" nothingOption="Country" :options="$countries" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Email Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[shipping][email_address]" placeholder="Email Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Mailing Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[shipping][mailing_address]" placeholder="Mailing Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>Country</label>
                                                    <div class="form-input form">
                                                        <x-form.s-select name="addr[shipping][country]" nothingOption="Country" :options="$countries" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                            ...
                            <div class="sub-total-price">
                                @foreach ($cart->get() as $item)
                                    <div class="total-price">
                                        ...
                                        <p class="price">{{ App\Helpers\Currency::format($item->product->price) }}</p>
                                    </div>
                                @endforeach
                            </div>
